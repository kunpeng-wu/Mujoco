...
class Controller(object, metaclass=abc.ABCMeta):
    ...
    def __init__(
        ...
        # Torques being outputted by the manipulator
        self.torques = None
        ...
        # Initialize manipulator by updating internal state and setting the initial joint, pos, and ori
        self.update()
    ...
    def update_initial_joints(self, initial_joints):
        """
        Updates the internal attribute self.initial_joints. This is useful for updating changes in manipulator-specific
        behavior, such as with OSC where self.initial_joints is used for determine nullspace actions

        This function can also be extended by subclassed controllers for additional manipulator-specific updates
    ...
    def actuator_limits(self):
        """
        Torque limits for this manipulator
    ...
    def control_limits(self):
        """
        Limits over this manipulator's action space, which defaults to input min/max
    ...
    def name(self):
        """
        Name of this manipulator

        Returns:
            str: manipulator name
        """
        raise NotImplementedError
