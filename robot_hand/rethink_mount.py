...
from robosuite.utils.mjcf_utils import xml_path_completion, MOUNT_COLLISION_COLOR
...
class RethinkMount(MountModel):
    """
    Mount officially used for Rethink's Sawyer Robot. Includes a manipulator box and wheeled pedestal.
